...
public class Custom_State extends BoardState{
    ...
    public int[][] board = new int[2][2*BOARD_WIDTH];
    ...
    private Custom_State(int[][] board, int turn_number, int winner, int turn_player, int first_player){
        super();
    ...
    @Override
    public Object clone() {
        return new Custom_State(board, turn_number, winner, turn_player, first_player);
    }
